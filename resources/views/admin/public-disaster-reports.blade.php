...
@section('page-subtitle', 'View and manage disaster reports submitted by the public.')
            ...
            <table>
                ...
                @forelse ($reports as $report)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.public-disaster-reports.show', $report->id) }}" class="action-link">Review</a>
                        </td>
                    </tr>
                @empty
                    <tr><td colspan="7" class="empty-state">No disaster reports found.</td></tr>
                @endforelse
                </tbody>
            </table>
        </div>
