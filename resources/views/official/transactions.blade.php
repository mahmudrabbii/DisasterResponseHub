...
@section('title', 'Transaction History - DisasterResponseHub')
@section('page-title', 'Transaction History')
@section('page-subtitle', 'View and monitor all donation transactions from ShurjoPay.')
...
@section('content')
    <section class="panel-card">
        ...
        <form method="GET" action="{{ route('official.transactions') }}" class="form-grid">
            ...
            <div class="form-actions">
                ...
                <a href="{{ route('official.transactions') }}" class="secondary-action">Clear filters</a>
            </div>
        </form>
    </section>
